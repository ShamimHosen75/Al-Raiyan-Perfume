...
import { useComboProducts } from '@/hooks/useShopData';
import { ArrowRight } from 'lucide-react';
import { Link } from 'react-router-dom';

export function ComboProducts() {
  const { data: products = [], isLoading } = useComboProducts();
      ...
      <section className="section-padding">
        <div className="container-shop">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold">Awesome Combo Offers</h2>
              <p className="text-muted-foreground mt-1">Get more for less</p>
            </div>
          </div>
